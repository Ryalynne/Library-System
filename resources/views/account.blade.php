                ...
                <tbody>
                    @forelse ($account as $student)
                        <tr>
                            ...
                            <td class="text-truncate">{{ $student->middle }}</td>
                            <td class="text-truncate">{{ $student->lastname }}</td>
                            <td class="text-truncate">{{ $student->class }}</td>
                            <td class="text-center col-1">
                                @if ($student->studimg)
                                    <img src="{{ asset('images/' . $student->studimg) }}" alt="No Image"
                                        class="img-fluid">
                                @else
                            <td class="text-center col-1">No Image Available</td>
                    @endif
                    </td>
                    <td>{{ $student->status }}</td>
                    <td class="text-center col-2">
                        <button type="button" class="btn btn-success edit-button btn-sm" data-id={{ $student->id }}
                        ...
                        <button type="button" class="btn btn-danger btn-sm remove-book" data-bs-toggle="modal"
                            data-bs-target="#backdrop" data-id={{ $student->id }}><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    ...
                    <div class="mb-3">
                        <label for="bookid" class="form-label">NAME</label>
                        <input type="text" class="form-control ">
                    </div>
                    <div class="mb-3">
