...
@section('content')
 <br>       
    ...
    <div class="container">
        ...
        <form>
            @csrf
            <div class="modal fade AddStudentModal" id="modal_addbook" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control t-datepublish" id="datepublish" name="datepublish"
                                    :value="old('datepublish')" placeholder="ex.BMA">
                    ...
                    <tbody>
                        @foreach ($books as $book)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 tr">
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-success edit-button btn-sm" data-id={{ $book->id }}
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#backdrop"><svg xmlns="http://www.w3.org/2000/svg" width="12"
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary btn-qr getbookid"
                                        ...
                                        data-bs-target="#qrcodemodal"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="16" height="16" fill="currentColor" class="bi bi-qr-code"
                                            viewBox="0 0 16 16">
