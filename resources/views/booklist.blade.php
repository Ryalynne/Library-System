    ...
    <div class="container">
        ...
        <div class="d-flex mb-1">
            <div class="me-auto p-2 btn-group">
                <button type="button" class="btn btn-success bg-success border-success" data-bs-toggle="modal" data-bs-target="#modal_addbook">
                    Register Books
                ...
                <button type="button" class="btn btn-success bg-success border-success print-tbl " data-bs-toggle="modal" data-bs-target="#tablemodal">
                    Print Book List
                ...
                <button type="button" class="btn btn-success bg-success border-success" data-bs-toggle="modal" data-bs-target="#modal_import">
                    Import
        ...
        <form>
            @csrf
            <div class="modal fade AddStudentModal" id="modal_addbook" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input style="text-transform:uppercase" type="text" class="form-control t-title" id="title" name="title" :value="old('title')" placeholder="ex.IAMSAR Manual Vol.1 Organization and Management">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input style="text-transform:uppercase" type="text" class="form-control t-author" id="author" name="author" :value="old('author')" placeholder="ex.IMO">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control t-copyright" id="copyright" name="copyright" :value="old('copyright')" placeholder="ex.2023">
                            </div>
                            <p id="msgcopyright" class="text-danger"> </p>

                            <div class="mb-3">
                                <label for="accession" class="form-label">ACCESSION NO.</label>
                                <input type="text" class="form-control t-accession" id="accession" name="accession" :value="old('accession')" placeholder="ex.04313">
                            </div>
                            <p id="msgaccession" class="text-danger"> </p>

                            <div class="mb-3">
                                <label for="callnumber" class="form-label">CALL NO.</label>
                                <input type="text" class="form-control t-callnumber" id="callnumber" name="callnumber" :value="old('callnumber')" placeholder="ex.04313">
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="subject" id="subject" class="form-control t-subject">
                                        <option value="" {{ request('subject') ? '' : 'selected' }}>Select Subject</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control t-copies" id="copies" name="copies" :value="old('copies')" placeholder="ex.20">
                            </div>
                        ...
                        <tbody>
                            ...
                            @endif
                                ...
                                <td class="text-center col-2">
                                    <button type="button" class="btn btn-success edit-button btn-sm" data-id={{ $book->id }} data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm remove-book" data-bs-toggle="modal" data-bs-target="#backdrop" data-id={{ $book->id }}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                                            <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                                        </svg></button>

                                    <button type="button" class="btn btn-sm btn-primary btn-qr getbookid" data-bs-toggle="modal" data-id={{ $book->id }} data-bs-target="#qrcodemodal"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-qr-code" viewBox="0 0 16 16">
        ...
        <div class="modal fade AddUpdate" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control modal-book-id" id="bookid" name="bookid" :value="old('bookid')" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="updatetitle" class="form-label">TITLE</label>
                            <input style="text-transform:uppercase" type="text" class="form-control modal-book-title" id="updatetitle" name="updatetitle" :value="old('updatetitle')">
                        </div>
                        <p id="msg1title" class="text-danger"> </p>
                        
                        <div class="mb-3">
                            <label for="updateauthor" class="form-label">AUTHOR/S</label>
                            <input style="text-transform:uppercase" type="text" class="form-control modal-book-author" id="updateauthor" name="updateauthor" :value="old('updateauthor')">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input style="text-transform:uppercase" type="text" class="form-control modal-book-copyright" id="updatecopyright" name="updatecopyright" :value="old('updatecopyright')">
                        </div>
                        <p id="msg1copyright" class="text-danger"> </p>

                        <div class="mb-3">
                            <label for="updateaccession" class="form-label">ACCESSION NO.</label>
                            <input style="text-transform:uppercase" type="text" class="form-control modal-book-accession" id="updateaccession" name="updateaccession" :value="old('updateaccession')">
                        </div>
                        <p id="msg1accession" class="text-danger"> </p>

                        <div class="mb-3">
                            <label for="updatecallnumber" class="form-label">CALL NO.</label>
                            <input style="text-transform:uppercase" type="text" class="form-control modal-book-callnumber" id="updatecallnumber" name="updatecallnumber" :value="old('updatecallnumber')">
                        </div>
        ...
        <div class="modal fade" id="qrcodemodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal fade" id="tablemodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-fullscreen">
                <div class="modal-content">
                    <div class="modal-header">
