    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-3 col-md-6 mb-5">
                <div class="card   shadow h-100 py-2 border-success border-bottom-0 border-end-0  border-top-0">
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-md-6 mb-5">
                <div
                    class="card border-left-primary shadow h-100 py-2 border-success border-3 border-bottom-0 border-end-0  border-top-0">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                            ...
                            <div class="col-auto">
                                <br>
                                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-arrow-counterclockwise" viewBox="0 0 16 16">
                ...
                <div
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    Number of Times Lend</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">1,000</div>
                            </div>
                            <div class="col-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-list-task" viewBox="0 0 16 16">
